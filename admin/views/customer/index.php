								...
								<table class="table app-table-hover mb-0 text-left">
									...
									<tbody>
										...
										foreach ($array['infor'] as $customer) {
											if ($customer['username'] != $_SESSION['username'] && $customer['account_id'] != '1') {
							...
							<div class="table-responsive">
								<table class="table app-table-hover mb-0 text-left">
									...
									<tbody>
										...
										$id = 1;
										foreach ($array['infor'] as $customer) {
											if ($customer['username'] != $_SESSION['username'] && $customer['role_id'] == '1' && $customer['account_id'] != '1') {
										?>
												<tr>
													<td class="cell"><?php echo $id++ ?></td>
													<td class="cell">
							...
							<div class="table-responsive">
								<table class="table app-table-hover mb-0 text-left">
									...
									<tbody>
										...
										$id = 1;
										foreach ($array['infor'] as $customer) {
											if ($customer['username'] != $_SESSION['username'] && $customer['role_id'] == '2' && $customer['account_id'] != '1') {
										?>
												<tr>
													<td class="cell"><?php echo $id++ ?></td>
													<td class="cell">
